...
#El consumidor utiliza el exchange 'sam'
...
channel.queue_bind(exchange='sam', queue=queue_name, routing_key="traducir")
...
print(' sam_traduce Waiting for messages...')
...
def callback(ch, method, properties, body):
    ...
    if query.startswith("[traducir]") and len(str(body))<300:
        ...
        channel.basic_publish(exchange='sam', routing_key="publicar_slack", body="traducción es->en:"+str(result[0]))
